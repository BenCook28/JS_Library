...
// not completely unexpected) mishaps that interfere with the normal flow of a program.
...
// The throw statement interrupts execution of the function. It should get an
...
// The exception object will be delivered to the catch clause of a try statement as shown below:
...
// A try statement has a single catch block that will catch all exceptions. If your handling
// depends on the type of the exception, then the exception handler will have to
